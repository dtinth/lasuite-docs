    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_confirmation_id', models.UUIDField(default=uuid.uuid4, editable=False, null=True, unique=True)),
                ('inactive_confirmation_id', models.UUIDField(default=uuid.uuid4, editable=False, null=True, unique=True)),
